...
class CarrouselComponent extends StatefulWidget {
  const CarrouselComponent({super.key});

  @override
  State<CarrouselComponent> createState() => _CarrouselComponentState();
}

class _CarrouselComponentState extends State<CarrouselComponent> {
